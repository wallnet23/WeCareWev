...
@Component({
  ...
  templateUrl: './step-four-old.component.html',
  styleUrl: './step-four-old.component.scss'
})
export class StepFourOldComponent implements OnInit {
